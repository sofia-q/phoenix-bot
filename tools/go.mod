// Separate module so the Atlas schema provider and everything it drags in
// (Cloud Spanner, sqlite, postgres, sqlserver) stays out of the bot's
// dependency graph, and out of the go mod download in the Dockerfile.
module phoenixbot/tools

go 1.25.0

require (
	ariga.io/atlas-provider-gorm v0.6.1
	phoenixbot/bot v0.0.0
)
